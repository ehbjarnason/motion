...
def polyline_editor():
    ...
    class PolyLineEditor():
        def __init__(self, poly_line):
            self.line = poly_line
            self.xdata = list(self.line.get_xdata())
            self.ydata = list(self.line.get_ydata())
    ...
    poly_line_handle = PolyLineEditor(poly_line)
    ...
    print(poly_line.get_data())

    # convert line_obj to image matrix
